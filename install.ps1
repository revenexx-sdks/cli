...
# REPO
$GITHUB_x64_URL = "https://github.com/revenexx/cli/releases/download/1.0.0/revenexx-cli-win-x64.exe"
$GITHUB_arm64_URL = "https://github.com/revenexx/cli/releases/download/1.0.0/revenexx-cli-win-arm64.exe"
