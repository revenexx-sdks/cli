...
#   ./test.sh login
#
# By default this builds dist/cli.cjs (only when missing or out of date) and
...
if [ "$needs_build" = "1" ]; then
  echo "[test.sh] building dist/cli.cjs..."
  npm run build:cli
fi
